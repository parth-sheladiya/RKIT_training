...
CREATE TABLE Marks (
    ...
    MarksObtained INT,                 -- marks obtained by the student
    Subject VARCHAR(50),               -- subject of the marks record
...
ADD RoomNumber VARCHAR(10);  -- column to store room number information
...
ALTER TABLE Teachers 
ADD CONSTRAINT PK_TeacherID PRIMARY KEY (TeacherID);  -- setting 'TeacherID' as the primary key

-- change the data type of 'Gender' column in Students table from VARCHAR(10) to VARCHAR(20)
ALTER TABLE Students 
MODIFY Gender VARCHAR(20);  -- modifying the 'Gender' column to accept more characters
...
ALTER TABLE Students CHANGE Gender StudentGender VARCHAR(20);  -- renaming and changing the column 'Gender'
