...
$(document).ready(function () {
    ...
    $("#register-btn").dxButton({
        ...
        onClick: function () {
            ...
            if (!isValid) {
                DisplayNotifyMessage("Please fill all fields correctly!", "error", 4000);
                return;
            }
            let requestData = {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    DisplayNotifyMessage("User Registered Successfully!", "success", 3000);
                ...
                error: function (err) {
                   DisplayNotifyMessage("Error: " + err.responseText, "error", 2000);
                }
            });
        }
    });
