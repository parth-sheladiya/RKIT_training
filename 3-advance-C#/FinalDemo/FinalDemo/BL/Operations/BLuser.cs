...
namespace FinalDemo.BL.Operations
{
    public class BLuser : IDataHandler<UserDto>
    {
        ...
        //public bool IsExists(string userName, string userPassword)
        //{
        //    string encryptPassword = BLencryption.GetEncryptPassword(userPassword);
        ...
        //                    &&
        //            u.userPassword.Equals(encryptPassword));
        //    }
        ...
        //            var existingUser = db.SingleById<User>(id);
        //            if (existingUser == null)
        //            {
        //                _objResponce.IsError = true;
        //                _objResponce.Message = "User does not exist.";
        ...
        //        _objResponce.IsError = false;
        //        _objResponce.Message = "User Deleted Successfully";
        //    }
        //    catch (Exception ex)
        //    {
        //        _objResponce.IsError = true;
        //        _objResponce.Message = $"Data not Deleted: {ex.Message}";
        //    }
        ...
        //public void PreSave(UserDto objDto)
        //{
        //    _objUser = objDto.ConvertTo<User>();
        //    _objUser.userPassword = BLencryption.GetEncryptPassword(_objUser.userPassword);
        ...
        //    try
        //    {
        //        // Ensure that userId is set before saving
        //        if (_objUser.userId <= 0 && Type == EnumType.E)
        //        {
        //            _objResponce.IsError = true;
        //            _objResponce.Message = "User ID is required for update.";
        //            return _objResponce;
        //        }

        //        if (Type == EnumType.A)
        //        {
        //            return Add(_objUser); // Add new user
        //        }
        //        else if (Type == EnumType.E)
        //        {
        //            return Update(_objUser.userId, _objUser); // Update existing user
        //        }

        //        _objResponce.IsError = true;
        //        _objResponce.Message = "Internal Error: Invalid operation.";
        //        return _objResponce;
        //    }
        //    catch (Exception ex)
        //    {
